...
/**
 * Panorama de tesorería: saldos por cuenta, totales consolidados UYU/USD,
 * evolución de 12 meses y top categorías del mes.
 * Compartido por /api/tesoreria/reportes/panorama y el servidor MCP.
 */
export async function obtenerPanoramaTesoreria(supabase: SupabaseClient<Database>) {
