...
/**
 * Presupuesto vs. ejecutado por categoría (árbol) y por mes, en la moneda pedida.
 * Compartido por /api/tesoreria/presupuestos/ejecucion y el servidor MCP.
 */
export async function calcularEjecucionPresupuesto(
  supabase: SupabaseClient<Database>,
  { tipo, anio, numero, moneda }: ParamsEjecucion
) {
